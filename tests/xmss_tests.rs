#[cfg(test)]
mod xmss_tests {
    use hypercube_signatures::crypto::hash::{HashFunction, SHA256};
    use hypercube_signatures::xmss::{MerkleTree, XMSSKeypair, XMSSParams, XMSSSignature};
    ...
    fn test_xmss_signature_serialization() {
        ...
        assert!(keypair
            .public_key()
            .verify(message, &deserialized, keypair.params()));
    }
